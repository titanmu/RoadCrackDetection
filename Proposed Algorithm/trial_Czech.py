...
def detect(source, save_img=True):
    ...
    weights = 'weights/pave/Vishal/66JC/last.pt'    #Pass the correct path of the model
    view_img = True
    save_txt = False 
    imgsz  = 640
    device = ''
    ...
    classes = None;conf_thres = 0.30;agnostic_nms = False #Vm
...
with torch.no_grad():
    ...
    cnts = ['Czech']    #VM
    for cnt in cnts:
        img_source =os.path.join('../Trainer/test1',cnt,'images')       #Pass the correct path of the test1 dataset
