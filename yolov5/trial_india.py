...
def detect(source, save_img=True):
    weights = '/home/ai/bigDataComp/yolov5/weights/pave/test_prev/last_india_new.pt'
    view_img = True
    save_txt = False 
    imgsz  = 640
    device = ''
    ...
    classes = None;conf_thres = 0.25;agnostic_nms = False    #VM
...
with torch.no_grad():
    ...
    cnts = ['India']
    for cnt in cnts:
        img_source =os.path.join('../Trainer/test1',cnt,'images')
